...
} __attribute__((packed)) randomIntegerPack_t;
...
typedef nx_struct resultPack {
  ...
  nx_uint32_t average;
  nx_uint32_t median;
} __attribute__((packed)) resultPack_t;
...
static void CalculateNodeC__Boot__booted(void );
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void CalculateNodeC__AMSend__sendDone(
#line 92
message_t * msg, 
...
static void CalculateNodeC__RadioControl__startDone(error_t error);
#line 117
static void CalculateNodeC__RadioControl__stopDone(error_t error);
...
CalculateNodeC__Receive__receive(
#line 60
message_t * msg, 
void * payload, 
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
/*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 85
message_t * msg, 
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t CalculateNodeC__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
CalculateNodeC__AMSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t CalculateNodeC__RadioControl__start(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void CalculateNodeC__Leds__led0Toggle(void );
#line 72
static void CalculateNodeC__Leds__led1Toggle(void );
#line 89
static void CalculateNodeC__Leds__led2Toggle(void );
# 15 "CalculateNodeC.nc"
message_t CalculateNodeC__sendBuf;
resultPack_t CalculateNodeC__local;
randomIntegerPack_t CalculateNodeC__request;
uint16_t CalculateNodeC__currentTop = 0;
uint16_t CalculateNodeC__localCount = 0;
uint32_t CalculateNodeC__localSum = 0;
uint32_t CalculateNodeC__localNumbers[TOTAL_NUM];
bool CalculateNodeC__sendBusy = FALSE;
bool CalculateNodeC__over = FALSE;


static inline void CalculateNodeC__report_problem(void );
static inline void CalculateNodeC__report_sent(void );
static inline void CalculateNodeC__report_received(void );

static inline void CalculateNodeC__Boot__booted(void );
...
static inline void CalculateNodeC__reportAbcense(uint16_t sequence);
#line 51
static inline void CalculateNodeC__sendAbsense(uint16_t sequence, uint32_t num);
...
static inline void CalculateNodeC__update(uint32_t newNum);
#line 77
static inline void CalculateNodeC__RadioControl__startDone(error_t error);



static inline void CalculateNodeC__RadioControl__stopDone(error_t error);


static inline void CalculateNodeC__sendResult(void );
...
static void CalculateNodeC__swap(uint16_t left, uint16_t right);
...
static inline uint16_t CalculateNodeC__partition(uint16_t left, uint16_t right);
#line 123
static uint32_t CalculateNodeC__getKIndex(uint16_t midPos);
#line 148
static inline void CalculateNodeC__getResult(void );





static inline message_t *CalculateNodeC__Receive__receive(message_t *msg, void *payload, uint8_t len);
#line 193
static inline void CalculateNodeC__AMSend__sendDone(message_t *msg, error_t error);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
message_t *msg);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 56
message_t * msg, 
...
/*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__getPayload(
#line 111
message_t * msg, 
...
static void /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 147
message_t * amsg, 
...
static error_t /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
...
static inline void */*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__getPayload(message_t *m, uint8_t len);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x40699428){
#line 28
  switch (arg_0x40699428) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x40699428);
#line 28
      break;
#line 28
    }
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x40fb84a0, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x40fb84a0, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40b82c68){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  switch (arg_0x40b82c68) {
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40b82c68);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40b81798){
#line 39
  union __nesc_unnamed4285 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40b81798);
#line 39
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40c95030){
#line 49
  switch (arg_0x40c95030) {
#line 49
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40c95030);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40c97c10){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40c97c10);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40b82c68){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40b82c68);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x40c97c10){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x40c97c10);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40b82c68){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40b82c68);
#line 78
      break;
#line 78
    }
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40c95030){
#line 55
  switch (arg_0x40c95030) {
#line 55
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40c95030);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40b82c68){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40b82c68);
#line 110
      break;
#line 110
    }
...
inline static void CalculateNodeC__Leds__led1Toggle(void ){
#line 72
  LedsP__Leds__led1Toggle();
#line 72
}
#line 72
# 27 "CalculateNodeC.nc"
static inline void CalculateNodeC__report_sent(void )
#line 27
{
#line 27
  CalculateNodeC__Leds__led1Toggle();
}
...
{
  if (error == SUCCESS) {
      CalculateNodeC__sendBusy = FALSE;
      CalculateNodeC__report_sent();
    }
  else 
    {
    }
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  CalculateNodeC__AMSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x410341e0, message_t * msg, error_t error){
#line 89
  switch (arg_0x410341e0) {
#line 89
    case 0U:
#line 89
      /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x410341e0, msg, error);
#line 89
      break;
#line 89
    }
...
#line 56
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x41034bc8, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x41034bc8, addr, msg, len);
#line 69
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x40fb9e18, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x40fb9e18, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x40fb84a0, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x40fb84a0, msg);
#line 95
}
#line 95
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x40fba440, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x40fba440, msg, payload, len);
#line 67
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t CalculateNodeC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 69
...
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__getPayload(am_id_t arg_0x41034bc8, message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = CC2420ActiveMessageP__AMSend__getPayload(arg_0x41034bc8, msg, len);
#line 124
...
# 114 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void * /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__getPayload(message_t * msg, uint8_t len){
#line 114
  void *__nesc_result;
#line 114
...
#line 65
{
  return /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__getPayload(m, len);
}

# 124 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * CalculateNodeC__AMSend__getPayload(message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__getPayload(msg, len);
#line 124
...
#line 124
# 51 "CalculateNodeC.nc"
static inline void CalculateNodeC__sendAbsense(uint16_t sequence, uint32_t num)
#line 51
{
  if (!CalculateNodeC__sendBusy) {
      __nesc_hton_uint16(CalculateNodeC__request.sequence_number.data, sequence);
      __nesc_hton_uint32(CalculateNodeC__request.random_integer.data, num);
      memcpy(CalculateNodeC__AMSend__getPayload(&CalculateNodeC__sendBuf, sizeof CalculateNodeC__request), &CalculateNodeC__request, sizeof CalculateNodeC__request);
      if (CalculateNodeC__AMSend__send(AM_BROADCAST_ADDR, &CalculateNodeC__sendBuf, sizeof CalculateNodeC__request) == SUCCESS) {
        CalculateNodeC__sendBusy = TRUE;
        }
#line 58
      if (!CalculateNodeC__sendBusy) {
#line 58
...
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void CalculateNodeC__Leds__led0Toggle(void ){
#line 56
  LedsP__Leds__led0Toggle();
#line 56
}
#line 56
# 26 "CalculateNodeC.nc"
static inline void CalculateNodeC__report_problem(void )
#line 26
{
#line 26
  CalculateNodeC__Leds__led0Toggle();
}
...
#line 84
{
  CalculateNodeC__report_problem();
  if (!CalculateNodeC__sendBusy) {
      memcpy(CalculateNodeC__AMSend__getPayload(&CalculateNodeC__sendBuf, sizeof CalculateNodeC__local), &CalculateNodeC__local, sizeof CalculateNodeC__local);
      if (CalculateNodeC__AMSend__send(0, &CalculateNodeC__sendBuf, sizeof CalculateNodeC__local) == SUCCESS) {
        CalculateNodeC__sendBusy = TRUE;
        }
#line 90
      if (!CalculateNodeC__sendBusy) {
...
#line 148
{
  __nesc_hton_uint32(CalculateNodeC__local.average.data, __nesc_ntoh_uint32(CalculateNodeC__local.sum.data) / TOTAL_NUM);
  __nesc_hton_uint32(CalculateNodeC__local.median.data, (CalculateNodeC__getKIndex(CalculateNodeC__localCount / 2) + CalculateNodeC__getKIndex(CalculateNodeC__localCount / 2 - 1)) / 2);
  CalculateNodeC__sendResult();
}
...
#line 62
{
  if (CalculateNodeC__localCount == 0) 
    {
      __nesc_hton_uint32(CalculateNodeC__local.min.data, newNum);
      __nesc_hton_uint32(CalculateNodeC__local.max.data, newNum);
    }
  else 
#line 67
    {
      if (newNum > __nesc_ntoh_uint32(CalculateNodeC__local.max.data)) {
        __nesc_hton_uint32(CalculateNodeC__local.max.data, newNum);
        }
      else {
#line 70
        if (newNum < __nesc_ntoh_uint32(CalculateNodeC__local.min.data)) {
          __nesc_hton_uint32(CalculateNodeC__local.min.data, newNum);
          }
        }
    }
#line 73
  CalculateNodeC__localSum += newNum;
}
...
inline static void CalculateNodeC__Leds__led2Toggle(void ){
#line 89
  LedsP__Leds__led2Toggle();
#line 89
}
#line 89
# 28 "CalculateNodeC.nc"
static inline void CalculateNodeC__report_received(void )
#line 28
{
#line 28
  CalculateNodeC__Leds__led2Toggle();
}
...
{
  CalculateNodeC__report_sent();
  if (CalculateNodeC__localNumbers[sequence] == 10001 && !CalculateNodeC__sendBusy) {
      __nesc_hton_uint16(CalculateNodeC__request.sequence_number.data, sequence);
      __nesc_hton_uint32(CalculateNodeC__request.random_integer.data, 10001);
      memcpy(CalculateNodeC__AMSend__getPayload(&CalculateNodeC__sendBuf, sizeof CalculateNodeC__request), &CalculateNodeC__request, sizeof CalculateNodeC__request);
      if (CalculateNodeC__AMSend__send(AM_BROADCAST_ADDR, &CalculateNodeC__sendBuf, sizeof CalculateNodeC__request) == SUCCESS) {
        CalculateNodeC__sendBusy = TRUE;
        }
...
#line 154
{
  ...
  uint16_t thisSeq = __nesc_ntoh_uint16(rec->sequence_number.data) - 1;
#line 156
  uint16_t i;

#line 157
  if (!CalculateNodeC__over) {
      if (TOS_NODE_ID == 3 * GROUP_ID + 1) {
          if (CalculateNodeC__localNumbers[thisSeq] == 10001 && __nesc_ntoh_uint32(rec->random_integer.data) != 10001) {
              if (thisSeq > CalculateNodeC__currentTop + 1) 
                {
                  for (i = CalculateNodeC__currentTop + 1; i < thisSeq; i++) 
                    {
                      CalculateNodeC__reportAbcense(i + 1);
                    }
                }
              if (thisSeq > CalculateNodeC__currentTop) {
                  CalculateNodeC__currentTop = thisSeq;
                }
              CalculateNodeC__report_received();
              CalculateNodeC__update(__nesc_ntoh_uint32(rec->random_integer.data));
              CalculateNodeC__localNumbers[thisSeq] = __nesc_ntoh_uint32(rec->random_integer.data);
              CalculateNodeC__localCount++;
              if (CalculateNodeC__localCount == TOTAL_NUM) {
                  CalculateNodeC__getResult();
                }
            }
        }
      else 
#line 178
        {
          if (__nesc_ntoh_uint32(rec->random_integer.data) != 10001) {
              CalculateNodeC__localNumbers[thisSeq] = __nesc_ntoh_uint32(rec->random_integer.data);
            }
          else 
#line 181
            {
              if (CalculateNodeC__localNumbers[thisSeq] != 10001) {
                CalculateNodeC__sendAbsense(thisSeq + 1, CalculateNodeC__localNumbers[thisSeq]);
                }
            }
        }
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x40fbbd98, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40fbbd98) {
#line 67
    case 1:
#line 67
      __nesc_result = CalculateNodeC__Receive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x40fbbd98, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
inline static void /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
#line 105
  ...
  while (left <= right) 
    {
      while (left < pos && CalculateNodeC__localNumbers[left] <= CalculateNodeC__localNumbers[pos]) 
        left++;

      while (right >= 0 && CalculateNodeC__localNumbers[right] > CalculateNodeC__localNumbers[pos]) 
        right--;

      if (left >= right) {
        break;
        }
      CalculateNodeC__swap(left, right);
    }
  CalculateNodeC__swap(left, pos);
  return left;
}
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40b85eb8){
#line 92
  switch (arg_0x40b85eb8) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40b85eb8);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40c971e8){
#line 92
  switch (arg_0x40c971e8) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40c971e8);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40b82470, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40b82470) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40b82470, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40adaa40, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40adaa40) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40adaa40, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x40fb84a0, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x40fb84a0, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40adaa40, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40adaa40) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40adaa40, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40ada010){
#line 92
  switch (arg_0x40ada010) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x40ada010);
#line 92
      break;
#line 92
    }
...
#line 89
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x40fbb3d8, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x40fbb3d8, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 117
  CalculateNodeC__RadioControl__stopDone(error);
#line 117
}
#line 117
...
#line 92
  CalculateNodeC__RadioControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t CalculateNodeC__RadioControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
#line 32
  for (i = 0; i < 2000; i++) {
      CalculateNodeC__localNumbers[i] = 10001;
    }
  if (CalculateNodeC__RadioControl__start() != SUCCESS) {
    CalculateNodeC__report_received();
    }
}
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40c66cc8, uint8_t data){
#line 54
  switch (arg_0x40c66cc8) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40c66cc8, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x40c635c8){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x40c635c8);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40c66cc8){
#line 49
  switch (arg_0x40c66cc8) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40c66cc8);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x40699428){
#line 28
  switch (arg_0x40699428) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x40699428);
#line 28
      break;
#line 28
    }
...
#line 47
{
  /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 1);
  return /*CalculateNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}
...
# 123 "CalculateNodeC.nc"
static uint32_t CalculateNodeC__getKIndex(uint16_t midPos)
{
  uint16_t left = 0;
  uint16_t right = CalculateNodeC__localCount - 1;
  uint16_t index = CalculateNodeC__localCount + 1;

#line 128
  while (index != midPos) 
    {
      index = CalculateNodeC__partition(left, right);
...
#line 145
  return CalculateNodeC__localNumbers[index];
}

#line 95
static void CalculateNodeC__swap(uint16_t left, uint16_t right)
{
  uint32_t temp = CalculateNodeC__localNumbers[left];

#line 98
  CalculateNodeC__localNumbers[left] = CalculateNodeC__localNumbers[right];
  CalculateNodeC__localNumbers[right] = temp;
}
